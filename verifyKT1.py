...
def verify_kt1(D, P, alpha=None, fail_fast=True, verbose=False):
    """
    ...
    alpha : int
        Defaults to None. alpha of key to be verified. If None, conditions
        that concern alpha will not be checked.
    fail_fast : bool
    ...
    if alpha is not None:
        checks = [
            check_c0, check_c1, check_c2, check_c3, check_c4, check_c5, 
            check_c6_c7, check_c8, check_c9, check_c10, check_c11, check_c12, 
            check_c13, check_c14
        ]
    else:
        checks = [
            check_c0, check_c1, check_c2, check_c5, check_c6_c7, check_c8, 
            check_c9, check_c10, check_c11, check_c12, check_c13, check_c14
        ]
